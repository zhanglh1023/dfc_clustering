...
from main import CalCost
from main import CalCenter
from main import CalDistance
from main import CalGFViolation, CalDSViolation
...
def fair_clustering(dataset, config_file, data_dir, num_clusters, deltas, max_points, violating, violation, shiyan):
    ...
    for center in vanilla_centers:
        print(center)
    vanilla_cost = CalCost(data, vanilla_centers, vanilla_assignment)
    #return
    ...
    for delta in deltas:
       ...
       # print("points:")
        ...
        #print(gf_centers)
        gf_cost = CalCost(data, gf_centers, gf_assignment)
        ...
        double_fair_cost = CalCost(data, double_fair_centers, double_fair_assignment)
        Oral_cost = CalCost(data, Oral_centers, Oral_assignment)
        mx_cluster_size = 0
