...
plt.plot(x_axis_data, y_axis_Oral_GFTOGFDS_POF, 'g*-', linewidth = 1, label = "ORIG-GFTOGFDS-PoF")
plt.plot(x_axis_data, y_axis_SNC_GFTOGFDS_POF, 'rv-', linewidth = 1, label = "SNC-GFTOGFDS-PoF")
plt.ylabel('Price of Fairness')

plt.xlabel('Number of Clusters')
plt.title('creditcard_education')
plt.legend()
plt.show()
...
plt.plot(x_axis_data, Oral_GFTOGFDS_GFVio, 'g*-', linewidth = 1, label = "ORIG-GFTOGFDS-GFViolation")
plt.plot(x_axis_data, SNC_GFTOGFDS_GFVio, 'rv-', linewidth = 1, label = "SNC-GFTOGFDS-GFViolation")
...
plt.plot(x_axis_data, Oral_GFTOGFDS_DSVio, 'g*-', linewidth = 1, label = "ORIG-GFTOGFDS-DSViolation")
plt.plot(x_axis_data, SNC_GFTOGFDS_DSVio, 'rv-', linewidth = 1, label = "SNC-GFTOGFDS-DSViolation")
